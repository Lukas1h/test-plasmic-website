...
import sty from "./PlasmicContactSection.module.css"; // plasmic-import: nBfKaxyhlTEF/css
...
function PlasmicContactSection__RenderFunc(props: {
  ...
  return (
    <Stack__
      ...
      id={"contact"}
    >
      <div className={classNames(projectcss.all, sty.freeBox__scbRt)}>
        <h2
        ...
        <div className={classNames(projectcss.all, sty.freeBox__u8HnI)}>
          <PlasmicLink__
