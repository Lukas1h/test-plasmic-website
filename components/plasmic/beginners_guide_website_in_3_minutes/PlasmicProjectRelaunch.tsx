...
import sty from "./PlasmicProjectRelaunch.module.css"; // plasmic-import: Dr_4R_KXUGSx/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section__vmA3A)}
            id={"Services"}
          >
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__sx9)}
              displayHeight={"700px"}
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section__jlLDz)}
            id={"work"}
          >
            <div className={classNames(projectcss.all, sty.freeBox___83Jss)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__k3JTl)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox___8Brw)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__dPnL)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox___29RcG)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__ieg37)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
                ...
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.columns__nTh9X)}
                >
                  <div
                    className={classNames(projectcss.all, sty.column__e5YCh)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__zNd1U)}
                      displayHeight={
                  ...
                  <div className={classNames(projectcss.all, sty.column__dRxF)}>
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__uTbvU)}
                      displayHeight={
                        hasVariant(globalVariants, "screen", "mobileOnly")
                          ? "300px"
                          : "600px"
              ...
              <div className={classNames(projectcss.all, sty.freeBox__oD00C)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section___67LVr)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__glOlO)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__qYwr)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              <div className={classNames(projectcss.all, sty.freeBox__zgoEj)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__rLjLu)}
              id={"contact"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__vkXjf)}>
                <h2
              ...
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.columns__ovVxv)}
              >
                <div className={classNames(projectcss.all, sty.column__gMqfm)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard___5MFcJ
                    )}
                    image={{
                ...
                <div className={classNames(projectcss.all, sty.column__mhcCf)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__vJUhF
                    )}
