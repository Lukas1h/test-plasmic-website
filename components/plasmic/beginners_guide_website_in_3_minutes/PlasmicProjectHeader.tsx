...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: l-YePU5VGW3b/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__xgYMc)}>
        <div className={classNames(projectcss.all, sty.column__l1BN0)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__tWM)}>
          <div className={classNames(projectcss.all, sty.columns__gmfMe)}>
            <div className={classNames(projectcss.all, sty.column__g7UWd)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__sCuaz)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__kIout)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox___0CExC)}>
                {renderPlasmicSlot({
